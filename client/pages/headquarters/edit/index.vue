...
export default {
    ...
    return {
      compData: {
        ...
        editBtnClick() {
          ...
          btnsClick.edit(
            this.listFilters,
            domain.domain.backend1 + "hqtsRest/hq_update",
            {
              hq_seq: this.hqSeq,
        ...
        deleteBtnClick() {
          ...
          if (result) {
            btnsClick.delete(domain.domain.backend1 + "hqtsRest/hq_delete", {
              hq_seq: this.hqSeq,
              jwt: token
            })
          } else {
  ...
  mounted() {
    ...
    const self = this
    this.$axios
      .post(domain.domain.backend1 + axiosJson.hq.hq_info_one, {

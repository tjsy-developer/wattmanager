  ...
  <div class="col-6 column items-center accountRight">
    ...
    <div class="col row items-center">
      <div v-if="!isCreateQR" class="maxWidth">
        ...
        <!-- 비밀번호 규칙이 있는 경우만 -->
        <span v-if="checkPatern == 'true' || pswPaternHd == 'true'" class="pswPatern">{{ pwdRulesDescript }}</span>
...
export default {
  ...
  methods: {
    ...
    // 비밀번호 규칙이 있을 경우만
    passWordPaternCheck() {
      if (this.checkPatern != "true" && this.pswPaternHD != "true") this.validPassword = true

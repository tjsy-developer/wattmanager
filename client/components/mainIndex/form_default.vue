    ...
    <div class="col-6 row items-center indexRight">
      <div class="column col-12 items-center indexRightContent">
        <div class="col-12 row justify-center">
          ...
          <img v-if="useEnterprise == 'ex'" class="exloginContentLogo" src="@/assets/images/ex_pt_login.png" />
          <img v-if="useEnterprise == 'cmss'" class="cmssloginContentLogo" src="@/assets/images/logo_komipo.png" />
          <img v-if="useEnterprise == 'kdhc'" class="kdhcloginContentLogo" src="@/assets/images/logo_kdhc.png" />
        </div>

...
.row.justify-center.content-start.qrCreateContainer
	...
	.col-12.row.content-start
		...
		.col-12.row.inputOptions.items-center
			span.col-auto(v-show="false") {{ $t("safetyQR text")[0] }}
			input.col(v-model="pack" disabled v-show="false")
			.col-12.divisionLine(v-show="false")
			.col-12.row.inputOptions.items-center
			span.col-auto {{ $t("safetyQR text")[1] }}
			input.col(v-model="title" :placeholder='$t("safetyQR text")[4]')
			.col-12.divisionLine
			.col-12.row.inputOptions.items-center(v-show="false")
			span.col-auto(v-show="false") {{ $t("safetyQR text")[2] }}
			input.col(v-model="type" v-show="false")
			.col-12.divisionLine(v-show="false")
			.col-12.row.inputOptions.items-center
			span.col-auto {{ $t("safetyQR text")[3] }}
			input.col(v-model="url" :placeholder='$t("safetyQR text")[5]')
			.col-12.divisionLine
		.col-12.createBtns
